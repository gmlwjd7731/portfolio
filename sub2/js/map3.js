 window.onload = function() {
    ...
    var options = {
        center: new daum.maps.LatLng(37.263273792141355, 127.64323832689368),
        level: 2
    };
    ...
    var markerPosition  = new daum.maps.LatLng(37.263273792141355, 127.64323832689368); 
    ...
    var options2 = {
        center: new daum.maps.LatLng(35.36839763173341, 129.03861830076227),
        level: 2
    };
    ...
    var markerPosition2  = new daum.maps.LatLng(35.36839763173341, 129.03861830076227); 
   ...
   var options3 = {
       center: new daum.maps.LatLng(35.19692866212878, 126.87803585569115),
       level: 2
   };
   ...
   var markerPosition3  = new daum.maps.LatLng(35.19692866212878, 126.87803585569115); 
